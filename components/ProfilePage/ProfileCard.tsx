...
import { IconMoodLookDown, IconTrophy, IconPlayFootball, IconSquareRoundedPercentage, IconCalendar } from '@tabler/icons-react';
import CountUp from 'react-countup';

export default function ProfileCard({ gameCount, winCount, lossCount, daysSinceLastGame }: ProfileCardProps) {
    return (
        <Stack 
            mt="20px" 
            p="lg" 
        ...
        >
            ...
            <Group gap="xs">
                ...
                <Text size="xl" c={'#f1c40f'} fw={500}>
                    Win percentage: <CountUp end={gameCount > 0 ? (winCount / gameCount * 100) : 0} duration={1} decimals={1} />%
                </Text>
            </Group>
        </Stack>
    );

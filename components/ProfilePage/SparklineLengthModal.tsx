...
export const SparklineLengthModal = ({ opened, setOpened, onLengthSelect, maxLength, setDisplayMax }: SparklineLengthModalProps) => {
            ...
            <Stack mt="20px">
                {sparklineLengths.map((length) => (
                    <Button 
                        key={length}
                        variant="light" 
                        onClick={() => { onLengthSelect(length); setDisplayMax(false); }}
                    ...
                    <Button 
                        key={length}
                        variant="light" 
                        onClick={() => { onLengthSelect(maxLength); setDisplayMax(true); }}
                    >
                        Max
                    </Button>
            </Stack>
